...
>
> Map of commit `845f7cf` · 2026-07-10T07:39:55Z
...
|------|-------|-------|------------|
| **frontend** | 213 | 81,558 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
...
| **root** | 625 | 40,015 | Root — docs, config, role briefs |
...
*993 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
