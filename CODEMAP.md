...
>
> Map of commit `13bd847` · 2026-07-10T23:04:39Z
...
|------|-------|-------|------------|
| **frontend** | 220 | 82,568 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
...
| **root** | 631 | 40,385 | Root — docs, config, role briefs |
...
*1006 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
