...
>
> Map of commit `2a2066e` · 2026-07-08T20:15:57+01:00
...
|------|-------|-------|------------|
| **frontend** | 204 | 79,597 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
...
| **root** | 620 | 39,267 | Root — docs, config, role briefs |
...
*979 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
