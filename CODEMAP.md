...
>
> Map of commit `654a8d1` · 2026-07-10T23:35:46+01:00
...
|------|-------|-------|------------|
| **frontend** | 218 | 82,298 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
| **backend** | 23 | 4,543 | Backend — FastAPI (PDF ingest, extraction, REST API) |
...
graph LR
  ...
  n46[AnswerEvidenceOverlay.tsx] --> n8[requirement.ts]
  n47[AnswerFilterBar.tsx] --> n48[ExportMenu.tsx]
  n47[AnswerFilterBar.tsx] --> n44[answers.ts]
  n47[AnswerFilterBar.tsx] --> n8[requirement.ts]
  n40[AnswerPanel.tsx] --> n46[AnswerEvidenceOverlay.tsx]
  n40[AnswerPanel.tsx] --> n49[AnswerStateBadge.tsx]
  n40[AnswerPanel.tsx] --> n50[ApprovalStamp.tsx]
  ...
  n49[AnswerStateBadge.tsx] --> n8[requirement.ts]
  n51[AnswerWorkspace.tsx] --> n39[AnswerCard.tsx]
  n51[AnswerWorkspace.tsx] --> n44[answers.ts]
  n51[AnswerWorkspace.tsx] --> n8[requirement.ts]
  n1[AnswersBody.tsx] --> n47[AnswerFilterBar.tsx]
  n1[AnswersBody.tsx] --> n51[AnswerWorkspace.tsx]
  n1[AnswersBody.tsx] --> n52[AutofillButton.tsx]
  n1[AnswersBody.tsx] --> n53[CapabilityUpload.tsx]
  n1[AnswersBody.tsx] --> n54[GapInterview.tsx]
  n1[AnswersBody.tsx] --> n55[NoTenderLoaded.tsx]
  n1[AnswersBody.tsx] --> n56[ReadinessLedger.tsx]
  ...
  n52[AutofillButton.tsx] --> n57[AnimatedNumber.tsx]
  n52[AutofillButton.tsx] --> n6[RequirementsContext.tsx]
  n52[AutofillButton.tsx] --> n19[api.ts]
  n53[CapabilityUpload.tsx] --> n58[EvidenceLibrary.tsx]
  n53[CapabilityUpload.tsx] --> n6[RequirementsContext.tsx]
  n41[CategoryTag.tsx] --> n59[categoryStyle.ts]
  n60[CommandPalette.tsx] --> n61[matrix-derive.ts]
  n60[CommandPalette.tsx] --> n45[source-doc.ts]
  n60[CommandPalette.tsx] --> n62[triage.ts]
  n63[CommentThread.tsx] --> n6[RequirementsContext.tsx]
  n63[CommentThread.tsx] --> n19[api.ts]
  n63[CommentThread.tsx] --> n37[collaborators.ts]
  n64[ComplianceMatrix.tsx] --> n41[CategoryTag.tsx]
  n64[ComplianceMatrix.tsx] --> n42[ConfidenceIndicator.tsx]
  n64[ComplianceMatrix.tsx] --> n16[AuthContext.tsx]
  n64[ComplianceMatrix.tsx] --> n37[collaborators.ts]
  n64[ComplianceMatrix.tsx] --> n65[dedupe.ts]
  n64[ComplianceMatrix.tsx] --> n61[matrix-derive.ts]
  n64[ComplianceMatrix.tsx] --> n45[source-doc.ts]
  n64[ComplianceMatrix.tsx] --> n62[triage.ts]
  n64[ComplianceMatrix.tsx] --> n8[requirement.ts]
  n66[ControlPanel.tsx] --> n6[RequirementsContext.tsx]
  n66[ControlPanel.tsx] --> n19[api.ts]
  n66[ControlPanel.tsx] --> n37[collaborators.ts]
  n66[ControlPanel.tsx] --> n45[source-doc.ts]
  n66[ControlPanel.tsx] --> n62[triage.ts]
  n67[CurrentTenderStrip.tsx] --> n6[RequirementsContext.tsx]
  n67[CurrentTenderStrip.tsx] --> n19[api.ts]
  n5[DemoView.tsx] --> n57[AnimatedNumber.tsx]
  n5[DemoView.tsx] --> n64[ComplianceMatrix.tsx]
  n5[DemoView.tsx] --> n68[GatingHero.tsx]
  n5[DemoView.tsx] --> n69[GraphView.tsx]
  n5[DemoView.tsx] --> n10[SiteHeader.tsx]
  n5[DemoView.tsx] --> n70[SourceVerifyOverlay.tsx]
  n5[DemoView.tsx] --> n71[DemoScrolly.tsx]
  n5[DemoView.tsx] --> n72[DemoTitleCard.tsx]
  n5[DemoView.tsx] --> n73[MountOnView.tsx]
  n5[DemoView.tsx] --> n74[sample.ts]
  n5[DemoView.tsx] --> n75[BookDemoButton.tsx]
  n5[DemoView.tsx] --> n76[BotanicalSprig.tsx]
  n5[DemoView.tsx] --> n77[ClosingArrival.tsx]
  n5[DemoView.tsx] --> n78[DrawOn.tsx]
  n5[DemoView.tsx] --> n79[Reveal.tsx]
  n5[DemoView.tsx] --> n80[SiteFooter.tsx]
  n5[DemoView.tsx] --> n81[FernFrond.tsx]
  n5[DemoView.tsx] --> n82[TreelineDivider.tsx]
  n5[DemoView.tsx] --> n6[RequirementsContext.tsx]
  n5[DemoView.tsx] --> n19[api.ts]
  n5[DemoView.tsx] --> n62[triage.ts]
  n3[DocumentHeader.tsx] --> n10[SiteHeader.tsx]
  n3[DocumentHeader.tsx] --> n83[WorkspacePresence.tsx]
  n3[DocumentHeader.tsx] --> n6[RequirementsContext.tsx]
  n3[DocumentHeader.tsx] --> n59[categoryStyle.ts]
  n3[DocumentHeader.tsx] --> n62[triage.ts]
  n84[DocxSourceView.tsx] --> n19[api.ts]
  n84[DocxSourceView.tsx] --> n85[dom-highlight.ts]
  n84[DocxSourceView.tsx] --> n86[text-match.ts]
  n58[EvidenceLibrary.tsx] --> n6[RequirementsContext.tsx]
  n48[ExportMenu.tsx] --> n87[ExportReadinessSummary.tsx]
  n48[ExportMenu.tsx] --> n6[RequirementsContext.tsx]
  n48[ExportMenu.tsx] --> n88[export-matrix-xlsx.ts]
  n48[ExportMenu.tsx] --> n89[export-readiness.ts]
  n48[ExportMenu.tsx] --> n90[export-response.ts]
  n48[ExportMenu.tsx] --> n8[requirement.ts]
  n87[ExportReadinessSummary.tsx] --> n89[export-readiness.ts]
  n91[FocusMode.tsx] --> n92[RequirementPanel.tsx]
  n91[FocusMode.tsx] --> n62[triage.ts]
  n91[FocusMode.tsx] --> n8[requirement.ts]
  n54[GapInterview.tsx] --> n49[AnswerStateBadge.tsx]
  n54[GapInterview.tsx] --> n41[CategoryTag.tsx]
  n54[GapInterview.tsx] --> n43[OpenQuestions.tsx]
  n54[GapInterview.tsx] --> n6[RequirementsContext.tsx]
  n54[GapInterview.tsx] --> n45[source-doc.ts]
  n68[GatingHero.tsx] --> n6[RequirementsContext.tsx]
  n68[GatingHero.tsx] --> n65[dedupe.ts]
  n68[GatingHero.tsx] --> n45[source-doc.ts]
  n68[GatingHero.tsx] --> n8[requirement.ts]
  n18[GoogleSignInButton.tsx] --> n19[api.ts]
  n69[GraphView.tsx] --> n41[CategoryTag.tsx]
  n69[GraphView.tsx] --> n42[ConfidenceIndicator.tsx]
  n69[GraphView.tsx] --> n6[RequirementsContext.tsx]
  n69[GraphView.tsx] --> n19[api.ts]
  n69[GraphView.tsx] --> n59[categoryStyle.ts]
  n69[GraphView.tsx] --> n45[source-doc.ts]
  n69[GraphView.tsx] --> n93[structure.ts]
  n69[GraphView.tsx] --> n8[requirement.ts]
  n94[MarksView.tsx] --> n6[RequirementsContext.tsx]
  n94[MarksView.tsx] --> n45[source-doc.ts]
  n94[MarksView.tsx] --> n93[structure.ts]
  n94[MarksView.tsx] --> n8[requirement.ts]
  n21[MatrixView.tsx] --> n57[AnimatedNumber.tsx]
  n21[MatrixView.tsx] --> n2[AppMain.tsx]
  n21[MatrixView.tsx] --> n50[ApprovalStamp.tsx]
  n21[MatrixView.tsx] --> n95[BulkActionBar.tsx]
  n21[MatrixView.tsx] --> n60[CommandPalette.tsx]
  n21[MatrixView.tsx] --> n64[ComplianceMatrix.tsx]
  n21[MatrixView.tsx] --> n66[ControlPanel.tsx]
  n21[MatrixView.tsx] --> n3[DocumentHeader.tsx]
  n21[MatrixView.tsx] --> n84[DocxSourceView.tsx]
  n21[MatrixView.tsx] --> n91[FocusMode.tsx]
  n21[MatrixView.tsx] --> n68[GatingHero.tsx]
  n21[MatrixView.tsx] --> n55[NoTenderLoaded.tsx]
  n21[MatrixView.tsx] --> n96[PdfSourceView.tsx]
  n21[MatrixView.tsx] --> n97[RequirementDrawer.tsx]
  n21[MatrixView.tsx] --> n92[RequirementPanel.tsx]
  n21[MatrixView.tsx] --> n98[RequirementSpine.tsx]
  n21[MatrixView.tsx] --> n99[SheetSourceView.tsx]
  n21[MatrixView.tsx] --> n100[SourceActionIcon.tsx]
  n21[MatrixView.tsx] --> n6[RequirementsContext.tsx]
  n21[MatrixView.tsx] --> n19[api.ts]
  n21[MatrixView.tsx] --> n88[export-matrix-xlsx.ts]
  n21[MatrixView.tsx] --> n61[matrix-derive.ts]
  n21[MatrixView.tsx] --> n45[source-doc.ts]
  n21[MatrixView.tsx] --> n86[text-match.ts]
  n21[MatrixView.tsx] --> n62[triage.ts]
  n21[MatrixView.tsx] --> n8[requirement.ts]
  n55[NoTenderLoaded.tsx] --> n6[RequirementsContext.tsx]
  n55[NoTenderLoaded.tsx] --> n19[api.ts]
  n43[OpenQuestions.tsx] --> n6[RequirementsContext.tsx]
  n43[OpenQuestions.tsx] --> n19[api.ts]
  n43[OpenQuestions.tsx] --> n8[requirement.ts]
  n96[PdfSourceView.tsx] --> n19[api.ts]
  n96[PdfSourceView.tsx] --> n86[text-match.ts]
  n101[ProcessingView.tsx] --> n57[AnimatedNumber.tsx]
  n101[ProcessingView.tsx] --> n19[api.ts]
  n56[ReadinessLedger.tsx] --> n48[ExportMenu.tsx]
  n56[ReadinessLedger.tsx] --> n44[answers.ts]
  n56[ReadinessLedger.tsx] --> n8[requirement.ts]
  n97[RequirementDrawer.tsx] --> n92[RequirementPanel.tsx]
  n97[RequirementDrawer.tsx] --> n8[requirement.ts]
  n92[RequirementPanel.tsx] --> n40[AnswerPanel.tsx]
  n92[RequirementPanel.tsx] --> n50[ApprovalStamp.tsx]
  n92[RequirementPanel.tsx] --> n41[CategoryTag.tsx]
  n92[RequirementPanel.tsx] --> n63[CommentThread.tsx]
  n92[RequirementPanel.tsx] --> n42[ConfidenceIndicator.tsx]
  n92[RequirementPanel.tsx] --> n100[SourceActionIcon.tsx]
  n92[RequirementPanel.tsx] --> n70[SourceVerifyOverlay.tsx]
  n92[RequirementPanel.tsx] --> n16[AuthContext.tsx]
  n92[RequirementPanel.tsx] --> n6[RequirementsContext.tsx]
  n92[RequirementPanel.tsx] --> n19[api.ts]
  n92[RequirementPanel.tsx] --> n37[collaborators.ts]
  n92[RequirementPanel.tsx] --> n45[source-doc.ts]
  n92[RequirementPanel.tsx] --> n8[requirement.ts]
  n98[RequirementSpine.tsx] --> n42[ConfidenceIndicator.tsx]
  n98[RequirementSpine.tsx] --> n62[triage.ts]
  n102[ShareControl.tsx] --> n6[RequirementsContext.tsx]
  n102[ShareControl.tsx] --> n19[api.ts]
  n102[ShareControl.tsx] --> n37[collaborators.ts]
  n99[SheetSourceView.tsx] --> n19[api.ts]
  n99[SheetSourceView.tsx] --> n86[text-match.ts]
  n10[SiteHeader.tsx] --> n35[AccountMenu.tsx]
  n10[SiteHeader.tsx] --> n103[BrandLogo.tsx]
  n10[SiteHeader.tsx] --> n104[SectionNav.tsx]
  n10[SiteHeader.tsx] --> n75[BookDemoButton.tsx]
  n70[SourceVerifyOverlay.tsx] --> n84[DocxSourceView.tsx]
  n70[SourceVerifyOverlay.tsx] --> n96[PdfSourceView.tsx]
  n70[SourceVerifyOverlay.tsx] --> n99[SheetSourceView.tsx]
  n70[SourceVerifyOverlay.tsx] --> n19[api.ts]
  n70[SourceVerifyOverlay.tsx] --> n45[source-doc.ts]
  n70[SourceVerifyOverlay.tsx] --> n86[text-match.ts]
  n70[SourceVerifyOverlay.tsx] --> n8[requirement.ts]
  n14[StructureView.tsx] --> n69[GraphView.tsx]
  n14[StructureView.tsx] --> n94[MarksView.tsx]
  n14[StructureView.tsx] --> n55[NoTenderLoaded.tsx]
  n14[StructureView.tsx] --> n97[RequirementDrawer.tsx]
  n14[StructureView.tsx] --> n6[RequirementsContext.tsx]
  n14[StructureView.tsx] --> n19[api.ts]
  n14[StructureView.tsx] --> n93[structure.ts]
  n14[StructureView.tsx] --> n62[triage.ts]
  n14[StructureView.tsx] --> n8[requirement.ts]
  n31[TeamsManager.tsx] --> n19[api.ts]
  n31[TeamsManager.tsx] --> n37[collaborators.ts]
  n105[TendersList.tsx] --> n6[RequirementsContext.tsx]
  n105[TendersList.tsx] --> n19[api.ts]
  n106[UploadDropzone.tsx] --> n101[ProcessingView.tsx]
  n106[UploadDropzone.tsx] --> n107[RegisterPreview.tsx]
  n106[UploadDropzone.tsx] --> n6[RequirementsContext.tsx]
  n106[UploadDropzone.tsx] --> n108[demo-tender.ts]
  n106[UploadDropzone.tsx] --> n19[api.ts]
  n106[UploadDropzone.tsx] --> n45[source-doc.ts]
  n106[UploadDropzone.tsx] --> n8[requirement.ts]
  n34[UploadWorkspace.tsx] --> n2[AppMain.tsx]
  n34[UploadWorkspace.tsx] --> n67[CurrentTenderStrip.tsx]
  n34[UploadWorkspace.tsx] --> n3[DocumentHeader.tsx]
  n34[UploadWorkspace.tsx] --> n21[MatrixView.tsx]
  n34[UploadWorkspace.tsx] --> n105[TendersList.tsx]
  n34[UploadWorkspace.tsx] --> n106[UploadDropzone.tsx]
  n34[UploadWorkspace.tsx] --> n108[demo-tender.ts]
  n83[WorkspacePresence.tsx] --> n36[ActivityControl.tsx]
  n83[WorkspacePresence.tsx] --> n102[ShareControl.tsx]
  n71[DemoScrolly.tsx] --> n73[MountOnView.tsx]
  n71[DemoScrolly.tsx] --> n109[ScrollyStage.tsx]
  n71[DemoScrolly.tsx] --> n110[steps.ts]
  n71[DemoScrolly.tsx] --> n111[useScrollTimeline.ts]
  n71[DemoScrolly.tsx] --> n75[BookDemoButton.tsx]
  n72[DemoTitleCard.tsx] --> n74[sample.ts]
  n72[DemoTitleCard.tsx] --> n82[TreelineDivider.tsx]
  n109[ScrollyStage.tsx] --> n50[ApprovalStamp.tsx]
  n109[ScrollyStage.tsx] --> n41[CategoryTag.tsx]
  n109[ScrollyStage.tsx] --> n42[ConfidenceIndicator.tsx]
  n109[ScrollyStage.tsx] --> n68[GatingHero.tsx]
  n109[ScrollyStage.tsx] --> n69[GraphView.tsx]
  n109[ScrollyStage.tsx] --> n112[GhostCursor.tsx]
  n109[ScrollyStage.tsx] --> n113[StageChrome.tsx]
  n109[ScrollyStage.tsx] --> n74[sample.ts]
  n109[ScrollyStage.tsx] --> n110[steps.ts]
  n109[ScrollyStage.tsx] --> n81[FernFrond.tsx]
  n109[ScrollyStage.tsx] --> n114[PineBranch.tsx]
  n74[sample.ts] --> n8[requirement.ts]
  n77[ClosingArrival.tsx] --> n75[BookDemoButton.tsx]
  n77[ClosingArrival.tsx] --> n78[DrawOn.tsx]
  n77[ClosingArrival.tsx] --> n79[Reveal.tsx]
  n77[ClosingArrival.tsx] --> n114[PineBranch.tsx]
  n77[ClosingArrival.tsx] --> n115[Seal.tsx]
  n77[ClosingArrival.tsx] --> n82[TreelineDivider.tsx]
  n116[ForestHeroLayers.tsx] --> n115[Seal.tsx]
  n117[HeroResolve.tsx] --> n64[ComplianceMatrix.tsx]
  n117[HeroResolve.tsx] --> n68[GatingHero.tsx]
  n117[HeroResolve.tsx] --> n6[RequirementsContext.tsx]
  n117[HeroResolve.tsx] --> n62[triage.ts]
  n23[Landing.tsx] --> n42[ConfidenceIndicator.tsx]
  n23[Landing.tsx] --> n10[SiteHeader.tsx]
  n23[Landing.tsx] --> n75[BookDemoButton.tsx]
  n23[Landing.tsx] --> n77[ClosingArrival.tsx]
  n23[Landing.tsx] --> n118[CredibilityBand.tsx]
  n23[Landing.tsx] --> n78[DrawOn.tsx]
  n23[Landing.tsx] --> n116[ForestHeroLayers.tsx]
  n23[Landing.tsx] --> n117[HeroResolve.tsx]
  n23[Landing.tsx] --> n119[HowItWorks.tsx]
  n23[Landing.tsx] --> n120[ProductShots.tsx]
  n23[Landing.tsx] --> n121[ProofScrolly.tsx]
  n23[Landing.tsx] --> n79[Reveal.tsx]
  n23[Landing.tsx] --> n80[SiteFooter.tsx]
  n23[Landing.tsx] --> n122[TrailDescent.tsx]
  n23[Landing.tsx] --> n114[PineBranch.tsx]
  n23[Landing.tsx] --> n123[PressedLeaf.tsx]
  n23[Landing.tsx] --> n115[Seal.tsx]
  n23[Landing.tsx] --> n82[TreelineDivider.tsx]
  n120[ProductShots.tsx] --> n49[AnswerStateBadge.tsx]
  n120[ProductShots.tsx] --> n50[ApprovalStamp.tsx]
  n120[ProductShots.tsx] --> n41[CategoryTag.tsx]
  n120[ProductShots.tsx] --> n42[ConfidenceIndicator.tsx]
  n121[ProofScrolly.tsx] --> n57[AnimatedNumber.tsx]
  n121[ProofScrolly.tsx] --> n124[ProofNumbers.tsx]
  n121[ProofScrolly.tsx] --> n79[Reveal.tsx]
  n80[SiteFooter.tsx] --> n103[BrandLogo.tsx]
  n80[SiteFooter.tsx] --> n75[BookDemoButton.tsx]
  n80[SiteFooter.tsx] --> n114[PineBranch.tsx]
  n80[SiteFooter.tsx] --> n115[Seal.tsx]
  n80[SiteFooter.tsx] --> n82[TreelineDivider.tsx]
  n115[Seal.tsx] --> n76[BotanicalSprig.tsx]
  n25[PitchDeck.tsx] --> n57[AnimatedNumber.tsx]
  n25[PitchDeck.tsx] --> n103[BrandLogo.tsx]
  n25[PitchDeck.tsx] --> n64[ComplianceMatrix.tsx]
  n25[PitchDeck.tsx] --> n68[GatingHero.tsx]
  n25[PitchDeck.tsx] --> n21[MatrixView.tsx]
  n25[PitchDeck.tsx] --> n120[ProductShots.tsx]
  n25[PitchDeck.tsx] --> n125[PitchScene.tsx]
  n25[PitchDeck.tsx] --> n126[TenderGlyph.tsx]
  n25[PitchDeck.tsx] --> n127[TenderPageFacsimile.tsx]
  n25[PitchDeck.tsx] --> n128[TrailMap.tsx]
  n25[PitchDeck.tsx] --> n129[TrailSteps.tsx]
  n25[PitchDeck.tsx] --> n6[RequirementsContext.tsx]
  n25[PitchDeck.tsx] --> n62[triage.ts]
  n125[PitchScene.tsx] --> n81[FernFrond.tsx]
  n125[PitchScene.tsx] --> n114[PineBranch.tsx]
  n125[PitchScene.tsx] --> n115[Seal.tsx]
  n16[AuthContext.tsx] --> n19[api.ts]
  n6[RequirementsContext.tsx] --> n16[AuthContext.tsx]
  n6[RequirementsContext.tsx] --> n108[demo-tender.ts]
  n6[RequirementsContext.tsx] --> n130[answer-store.ts]
  ...
  n108[demo-tender.ts] --> n8[requirement.ts]
  n131[mock-requirements.ts] --> n8[requirement.ts]
  n130[answer-store.ts] --> n8[requirement.ts]
  n44[answers.ts] --> n62[triage.ts]
  n44[answers.ts] --> n8[requirement.ts]
  n19[api.ts] --> n8[requirement.ts]
  n37[collaborators.ts] --> n8[requirement.ts]
  n65[dedupe.ts] --> n8[requirement.ts]
  n85[dom-highlight.ts] --> n86[text-match.ts]
  n88[export-matrix-xlsx.ts] --> n42[ConfidenceIndicator.tsx]
  n88[export-matrix-xlsx.ts] --> n90[export-response.ts]
  n88[export-matrix-xlsx.ts] --> n45[source-doc.ts]
  n88[export-matrix-xlsx.ts] --> n8[requirement.ts]
  n89[export-readiness.ts] --> n44[answers.ts]
  n89[export-readiness.ts] --> n8[requirement.ts]
  n90[export-response.ts] --> n45[source-doc.ts]
  n90[export-response.ts] --> n8[requirement.ts]
  n61[matrix-derive.ts] --> n65[dedupe.ts]
  n61[matrix-derive.ts] --> n93[structure.ts]
  n61[matrix-derive.ts] --> n62[triage.ts]
  n61[matrix-derive.ts] --> n8[requirement.ts]
  n45[source-doc.ts] --> n19[api.ts]
  n45[source-doc.ts] --> n8[requirement.ts]
  n93[structure.ts] --> n8[requirement.ts]
  n86[text-match.ts] --> n65[dedupe.ts]
  n62[triage.ts] --> n8[requirement.ts]
...
*1003 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
