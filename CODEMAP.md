...
>
> Map of commit `c1410b0` · 2026-07-10T21:04:43Z
...
|------|-------|-------|------------|
| **frontend** | 218 | 82,074 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
...
| **root** | 629 | 40,299 | Root — docs, config, role briefs |
...
graph LR
  ...
  n50[AnswerWorkspace.tsx] --> n39[AnswerCard.tsx]
  n50[AnswerWorkspace.tsx] --> n8[requirement.ts]
  n1[AnswersBody.tsx] --> n47[AnswerFilterBar.tsx]
  n1[AnswersBody.tsx] --> n50[AnswerWorkspace.tsx]
  n1[AnswersBody.tsx] --> n51[AutofillButton.tsx]
  n1[AnswersBody.tsx] --> n52[CapabilityUpload.tsx]
  n1[AnswersBody.tsx] --> n53[GapInterview.tsx]
  n1[AnswersBody.tsx] --> n54[NoTenderLoaded.tsx]
  n1[AnswersBody.tsx] --> n55[ReadinessLedger.tsx]
  ...
  n51[AutofillButton.tsx] --> n56[AnimatedNumber.tsx]
  n51[AutofillButton.tsx] --> n6[RequirementsContext.tsx]
  n51[AutofillButton.tsx] --> n19[api.ts]
  n52[CapabilityUpload.tsx] --> n57[EvidenceLibrary.tsx]
  n52[CapabilityUpload.tsx] --> n6[RequirementsContext.tsx]
  n41[CategoryTag.tsx] --> n58[categoryStyle.ts]
  n59[CommandPalette.tsx] --> n60[matrix-derive.ts]
  n59[CommandPalette.tsx] --> n45[source-doc.ts]
  n59[CommandPalette.tsx] --> n61[triage.ts]
  n62[CommentThread.tsx] --> n6[RequirementsContext.tsx]
  n62[CommentThread.tsx] --> n19[api.ts]
  n62[CommentThread.tsx] --> n37[collaborators.ts]
  n63[ComplianceMatrix.tsx] --> n41[CategoryTag.tsx]
  n63[ComplianceMatrix.tsx] --> n42[ConfidenceIndicator.tsx]
  n63[ComplianceMatrix.tsx] --> n16[AuthContext.tsx]
  n63[ComplianceMatrix.tsx] --> n37[collaborators.ts]
  n63[ComplianceMatrix.tsx] --> n64[dedupe.ts]
  n63[ComplianceMatrix.tsx] --> n60[matrix-derive.ts]
  n63[ComplianceMatrix.tsx] --> n45[source-doc.ts]
  n63[ComplianceMatrix.tsx] --> n61[triage.ts]
  n63[ComplianceMatrix.tsx] --> n8[requirement.ts]
  n65[ControlPanel.tsx] --> n6[RequirementsContext.tsx]
  n65[ControlPanel.tsx] --> n19[api.ts]
  n65[ControlPanel.tsx] --> n37[collaborators.ts]
  n65[ControlPanel.tsx] --> n45[source-doc.ts]
  n65[ControlPanel.tsx] --> n61[triage.ts]
  n66[CurrentTenderStrip.tsx] --> n6[RequirementsContext.tsx]
  n5[DemoView.tsx] --> n56[AnimatedNumber.tsx]
  n5[DemoView.tsx] --> n63[ComplianceMatrix.tsx]
  n5[DemoView.tsx] --> n67[GatingHero.tsx]
  n5[DemoView.tsx] --> n68[GraphView.tsx]
  n5[DemoView.tsx] --> n10[SiteHeader.tsx]
  n5[DemoView.tsx] --> n69[SourceVerifyOverlay.tsx]
  n5[DemoView.tsx] --> n70[DemoScrolly.tsx]
  n5[DemoView.tsx] --> n71[DemoTitleCard.tsx]
  n5[DemoView.tsx] --> n72[MountOnView.tsx]
  n5[DemoView.tsx] --> n73[sample.ts]
  n5[DemoView.tsx] --> n74[BookDemoButton.tsx]
  n5[DemoView.tsx] --> n75[BotanicalSprig.tsx]
  n5[DemoView.tsx] --> n76[ClosingArrival.tsx]
  n5[DemoView.tsx] --> n77[DrawOn.tsx]
  n5[DemoView.tsx] --> n78[Reveal.tsx]
  n5[DemoView.tsx] --> n79[SiteFooter.tsx]
  n5[DemoView.tsx] --> n80[FernFrond.tsx]
  n5[DemoView.tsx] --> n81[TreelineDivider.tsx]
  n5[DemoView.tsx] --> n6[RequirementsContext.tsx]
  n5[DemoView.tsx] --> n19[api.ts]
  n5[DemoView.tsx] --> n61[triage.ts]
  n3[DocumentHeader.tsx] --> n10[SiteHeader.tsx]
  n3[DocumentHeader.tsx] --> n82[WorkspacePresence.tsx]
  n3[DocumentHeader.tsx] --> n6[RequirementsContext.tsx]
  n3[DocumentHeader.tsx] --> n58[categoryStyle.ts]
  n3[DocumentHeader.tsx] --> n61[triage.ts]
  n83[DocxSourceView.tsx] --> n19[api.ts]
  n83[DocxSourceView.tsx] --> n84[dom-highlight.ts]
  n83[DocxSourceView.tsx] --> n85[text-match.ts]
  n57[EvidenceLibrary.tsx] --> n6[RequirementsContext.tsx]
  n48[ExportMenu.tsx] --> n86[ExportReadinessSummary.tsx]
  n48[ExportMenu.tsx] --> n6[RequirementsContext.tsx]
  n48[ExportMenu.tsx] --> n87[export-matrix-xlsx.ts]
  n48[ExportMenu.tsx] --> n88[export-readiness.ts]
  n48[ExportMenu.tsx] --> n89[export-response.ts]
  n48[ExportMenu.tsx] --> n8[requirement.ts]
  n86[ExportReadinessSummary.tsx] --> n88[export-readiness.ts]
  n90[FocusMode.tsx] --> n91[RequirementPanel.tsx]
  n90[FocusMode.tsx] --> n61[triage.ts]
  n90[FocusMode.tsx] --> n8[requirement.ts]
  n53[GapInterview.tsx] --> n49[AnswerStateBadge.tsx]
  n53[GapInterview.tsx] --> n41[CategoryTag.tsx]
  n53[GapInterview.tsx] --> n43[OpenQuestions.tsx]
  n53[GapInterview.tsx] --> n6[RequirementsContext.tsx]
  n53[GapInterview.tsx] --> n45[source-doc.ts]
  n67[GatingHero.tsx] --> n6[RequirementsContext.tsx]
  n67[GatingHero.tsx] --> n64[dedupe.ts]
  n67[GatingHero.tsx] --> n45[source-doc.ts]
  n67[GatingHero.tsx] --> n8[requirement.ts]
  n18[GoogleSignInButton.tsx] --> n19[api.ts]
  n68[GraphView.tsx] --> n41[CategoryTag.tsx]
  n68[GraphView.tsx] --> n42[ConfidenceIndicator.tsx]
  n68[GraphView.tsx] --> n6[RequirementsContext.tsx]
  n68[GraphView.tsx] --> n19[api.ts]
  n68[GraphView.tsx] --> n58[categoryStyle.ts]
  n68[GraphView.tsx] --> n45[source-doc.ts]
  n68[GraphView.tsx] --> n92[structure.ts]
  n68[GraphView.tsx] --> n8[requirement.ts]
  n93[MarksView.tsx] --> n6[RequirementsContext.tsx]
  n93[MarksView.tsx] --> n45[source-doc.ts]
  n93[MarksView.tsx] --> n92[structure.ts]
  n93[MarksView.tsx] --> n8[requirement.ts]
  n21[MatrixView.tsx] --> n56[AnimatedNumber.tsx]
  n21[MatrixView.tsx] --> n2[AppMain.tsx]
  n21[MatrixView.tsx] --> n94[ApprovalStamp.tsx]
  n21[MatrixView.tsx] --> n95[BulkActionBar.tsx]
  n21[MatrixView.tsx] --> n59[CommandPalette.tsx]
  n21[MatrixView.tsx] --> n63[ComplianceMatrix.tsx]
  n21[MatrixView.tsx] --> n65[ControlPanel.tsx]
  n21[MatrixView.tsx] --> n3[DocumentHeader.tsx]
  n21[MatrixView.tsx] --> n83[DocxSourceView.tsx]
  n21[MatrixView.tsx] --> n90[FocusMode.tsx]
  n21[MatrixView.tsx] --> n67[GatingHero.tsx]
  n21[MatrixView.tsx] --> n54[NoTenderLoaded.tsx]
  n21[MatrixView.tsx] --> n96[PdfSourceView.tsx]
  n21[MatrixView.tsx] --> n97[RequirementDrawer.tsx]
  n21[MatrixView.tsx] --> n91[RequirementPanel.tsx]
  ...
  n21[MatrixView.tsx] --> n87[export-matrix-xlsx.ts]
  n21[MatrixView.tsx] --> n60[matrix-derive.ts]
  n21[MatrixView.tsx] --> n45[source-doc.ts]
  n21[MatrixView.tsx] --> n85[text-match.ts]
  n21[MatrixView.tsx] --> n61[triage.ts]
  n21[MatrixView.tsx] --> n8[requirement.ts]
  n54[NoTenderLoaded.tsx] --> n6[RequirementsContext.tsx]
  n54[NoTenderLoaded.tsx] --> n19[api.ts]
  ...
  n96[PdfSourceView.tsx] --> n85[text-match.ts]
  n101[ProcessingView.tsx] --> n56[AnimatedNumber.tsx]
  n101[ProcessingView.tsx] --> n19[api.ts]
  n55[ReadinessLedger.tsx] --> n48[ExportMenu.tsx]
  n55[ReadinessLedger.tsx] --> n44[answers.ts]
  n55[ReadinessLedger.tsx] --> n8[requirement.ts]
  n97[RequirementDrawer.tsx] --> n91[RequirementPanel.tsx]
  n97[RequirementDrawer.tsx] --> n8[requirement.ts]
  n91[RequirementPanel.tsx] --> n40[AnswerPanel.tsx]
  n91[RequirementPanel.tsx] --> n94[ApprovalStamp.tsx]
  n91[RequirementPanel.tsx] --> n41[CategoryTag.tsx]
  n91[RequirementPanel.tsx] --> n62[CommentThread.tsx]
  n91[RequirementPanel.tsx] --> n42[ConfidenceIndicator.tsx]
  n91[RequirementPanel.tsx] --> n100[SourceActionIcon.tsx]
  n91[RequirementPanel.tsx] --> n69[SourceVerifyOverlay.tsx]
  n91[RequirementPanel.tsx] --> n16[AuthContext.tsx]
  n91[RequirementPanel.tsx] --> n6[RequirementsContext.tsx]
  n91[RequirementPanel.tsx] --> n19[api.ts]
  n91[RequirementPanel.tsx] --> n37[collaborators.ts]
  n91[RequirementPanel.tsx] --> n45[source-doc.ts]
  n91[RequirementPanel.tsx] --> n8[requirement.ts]
  n98[RequirementSpine.tsx] --> n42[ConfidenceIndicator.tsx]
  n98[RequirementSpine.tsx] --> n61[triage.ts]
  ...
  n99[SheetSourceView.tsx] --> n85[text-match.ts]
  n10[SiteHeader.tsx] --> n35[AccountMenu.tsx]
  n10[SiteHeader.tsx] --> n103[BrandLogo.tsx]
  n10[SiteHeader.tsx] --> n104[SectionNav.tsx]
  n10[SiteHeader.tsx] --> n74[BookDemoButton.tsx]
  n69[SourceVerifyOverlay.tsx] --> n83[DocxSourceView.tsx]
  n69[SourceVerifyOverlay.tsx] --> n96[PdfSourceView.tsx]
  n69[SourceVerifyOverlay.tsx] --> n99[SheetSourceView.tsx]
  n69[SourceVerifyOverlay.tsx] --> n19[api.ts]
  n69[SourceVerifyOverlay.tsx] --> n45[source-doc.ts]
  n69[SourceVerifyOverlay.tsx] --> n85[text-match.ts]
  n69[SourceVerifyOverlay.tsx] --> n8[requirement.ts]
  n14[StructureView.tsx] --> n68[GraphView.tsx]
  n14[StructureView.tsx] --> n93[MarksView.tsx]
  n14[StructureView.tsx] --> n54[NoTenderLoaded.tsx]
  ...
  n14[StructureView.tsx] --> n92[structure.ts]
  n14[StructureView.tsx] --> n61[triage.ts]
  ...
  n34[UploadWorkspace.tsx] --> n66[CurrentTenderStrip.tsx]
  ...
  n82[WorkspacePresence.tsx] --> n36[ActivityControl.tsx]
  n82[WorkspacePresence.tsx] --> n102[ShareControl.tsx]
  n70[DemoScrolly.tsx] --> n72[MountOnView.tsx]
  n70[DemoScrolly.tsx] --> n109[ScrollyStage.tsx]
  n70[DemoScrolly.tsx] --> n110[steps.ts]
  n70[DemoScrolly.tsx] --> n111[useScrollTimeline.ts]
  n70[DemoScrolly.tsx] --> n74[BookDemoButton.tsx]
  n71[DemoTitleCard.tsx] --> n73[sample.ts]
  n71[DemoTitleCard.tsx] --> n81[TreelineDivider.tsx]
  n109[ScrollyStage.tsx] --> n94[ApprovalStamp.tsx]
  n109[ScrollyStage.tsx] --> n41[CategoryTag.tsx]
  n109[ScrollyStage.tsx] --> n42[ConfidenceIndicator.tsx]
  n109[ScrollyStage.tsx] --> n67[GatingHero.tsx]
  n109[ScrollyStage.tsx] --> n68[GraphView.tsx]
  n109[ScrollyStage.tsx] --> n112[GhostCursor.tsx]
  n109[ScrollyStage.tsx] --> n113[StageChrome.tsx]
  n109[ScrollyStage.tsx] --> n73[sample.ts]
  n109[ScrollyStage.tsx] --> n110[steps.ts]
  n109[ScrollyStage.tsx] --> n80[FernFrond.tsx]
  n109[ScrollyStage.tsx] --> n114[PineBranch.tsx]
  n73[sample.ts] --> n8[requirement.ts]
  n76[ClosingArrival.tsx] --> n74[BookDemoButton.tsx]
  n76[ClosingArrival.tsx] --> n77[DrawOn.tsx]
  n76[ClosingArrival.tsx] --> n78[Reveal.tsx]
  n76[ClosingArrival.tsx] --> n114[PineBranch.tsx]
  n76[ClosingArrival.tsx] --> n115[Seal.tsx]
  n76[ClosingArrival.tsx] --> n81[TreelineDivider.tsx]
  n116[ForestHeroLayers.tsx] --> n115[Seal.tsx]
  n117[HeroResolve.tsx] --> n63[ComplianceMatrix.tsx]
  n117[HeroResolve.tsx] --> n67[GatingHero.tsx]
  n117[HeroResolve.tsx] --> n6[RequirementsContext.tsx]
  n117[HeroResolve.tsx] --> n61[triage.ts]
  n23[Landing.tsx] --> n42[ConfidenceIndicator.tsx]
  n23[Landing.tsx] --> n10[SiteHeader.tsx]
  n23[Landing.tsx] --> n74[BookDemoButton.tsx]
  n23[Landing.tsx] --> n76[ClosingArrival.tsx]
  n23[Landing.tsx] --> n118[CredibilityBand.tsx]
  n23[Landing.tsx] --> n77[DrawOn.tsx]
  ...
  n23[Landing.tsx] --> n78[Reveal.tsx]
  n23[Landing.tsx] --> n79[SiteFooter.tsx]
  ...
  n23[Landing.tsx] --> n81[TreelineDivider.tsx]
  n120[ProductShots.tsx] --> n49[AnswerStateBadge.tsx]
  n120[ProductShots.tsx] --> n94[ApprovalStamp.tsx]
  n120[ProductShots.tsx] --> n41[CategoryTag.tsx]
  n120[ProductShots.tsx] --> n42[ConfidenceIndicator.tsx]
  n121[ProofScrolly.tsx] --> n56[AnimatedNumber.tsx]
  n121[ProofScrolly.tsx] --> n124[ProofNumbers.tsx]
  n121[ProofScrolly.tsx] --> n78[Reveal.tsx]
  n79[SiteFooter.tsx] --> n103[BrandLogo.tsx]
  n79[SiteFooter.tsx] --> n74[BookDemoButton.tsx]
  n79[SiteFooter.tsx] --> n114[PineBranch.tsx]
  n79[SiteFooter.tsx] --> n115[Seal.tsx]
  n79[SiteFooter.tsx] --> n81[TreelineDivider.tsx]
  n115[Seal.tsx] --> n75[BotanicalSprig.tsx]
  n25[PitchDeck.tsx] --> n56[AnimatedNumber.tsx]
  n25[PitchDeck.tsx] --> n103[BrandLogo.tsx]
  n25[PitchDeck.tsx] --> n63[ComplianceMatrix.tsx]
  n25[PitchDeck.tsx] --> n67[GatingHero.tsx]
  ...
  n25[PitchDeck.tsx] --> n61[triage.ts]
  n125[PitchScene.tsx] --> n80[FernFrond.tsx]
  ...
  n44[answers.ts] --> n61[triage.ts]
  n44[answers.ts] --> n8[requirement.ts]
  n19[api.ts] --> n8[requirement.ts]
  n37[collaborators.ts] --> n8[requirement.ts]
  n64[dedupe.ts] --> n8[requirement.ts]
  n84[dom-highlight.ts] --> n85[text-match.ts]
  n87[export-matrix-xlsx.ts] --> n42[ConfidenceIndicator.tsx]
  n87[export-matrix-xlsx.ts] --> n89[export-response.ts]
  n87[export-matrix-xlsx.ts] --> n45[source-doc.ts]
  n87[export-matrix-xlsx.ts] --> n8[requirement.ts]
  n88[export-readiness.ts] --> n44[answers.ts]
  n88[export-readiness.ts] --> n8[requirement.ts]
  n89[export-response.ts] --> n45[source-doc.ts]
  n89[export-response.ts] --> n8[requirement.ts]
  n60[matrix-derive.ts] --> n64[dedupe.ts]
  n60[matrix-derive.ts] --> n92[structure.ts]
  n60[matrix-derive.ts] --> n61[triage.ts]
  n60[matrix-derive.ts] --> n8[requirement.ts]
  n45[source-doc.ts] --> n19[api.ts]
  n45[source-doc.ts] --> n8[requirement.ts]
  n92[structure.ts] --> n8[requirement.ts]
  n85[text-match.ts] --> n64[dedupe.ts]
  n61[triage.ts] --> n8[requirement.ts]
...
*1002 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
