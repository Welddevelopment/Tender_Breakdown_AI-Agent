...
>
> Map of commit `e70da5f` · 2026-07-08T21:12:13Z
...
|------|-------|-------|------------|
| **frontend** | 207 | 80,147 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
...
| **comms** | 5 | 2,896 | Comms — async agent message boards |
...
graph LR
  ...
  n34[UploadWorkspace.tsx] --> n6[RequirementsContext.tsx]
...
- `frontend/src/context/RequirementsContext.tsx` — exports `DEMO_DEFAULT_TENDER`
...
*983 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
