...
>
> Map of commit `826d1a0` · 2026-07-09T19:05:18Z
...
|------|-------|-------|------------|
| **frontend** | 210 | 80,164 | Frontend — Next.js 16 / React 19 / Tailwind (compliance matrix UI) |
...
| **root** | 623 | 39,794 | Root — docs, config, role briefs |
...
graph LR
  ...
  n45[AnswerFilterBar.tsx] --> n8[requirement.ts]
  n39[AnswerPanel.tsx] --> n47[AnswerStateBadge.tsx]
  n39[AnswerPanel.tsx] --> n6[RequirementsContext.tsx]
  n39[AnswerPanel.tsx] --> n8[requirement.ts]
  n47[AnswerStateBadge.tsx] --> n8[requirement.ts]
  n48[AnswerWorkspace.tsx] --> n38[AnswerCard.tsx]
  n48[AnswerWorkspace.tsx] --> n8[requirement.ts]
  n1[AnswersBody.tsx] --> n45[AnswerFilterBar.tsx]
  n1[AnswersBody.tsx] --> n48[AnswerWorkspace.tsx]
  n1[AnswersBody.tsx] --> n49[AutofillButton.tsx]
  n1[AnswersBody.tsx] --> n50[CapabilityUpload.tsx]
  n1[AnswersBody.tsx] --> n51[GapInterview.tsx]
  n1[AnswersBody.tsx] --> n52[NoTenderLoaded.tsx]
  n1[AnswersBody.tsx] --> n53[ReadinessLedger.tsx]
  ...
  n49[AutofillButton.tsx] --> n54[AnimatedNumber.tsx]
  n49[AutofillButton.tsx] --> n6[RequirementsContext.tsx]
  n49[AutofillButton.tsx] --> n19[api.ts]
  n50[CapabilityUpload.tsx] --> n55[EvidenceLibrary.tsx]
  n50[CapabilityUpload.tsx] --> n6[RequirementsContext.tsx]
  n40[CategoryTag.tsx] --> n56[categoryStyle.ts]
  n57[CommandPalette.tsx] --> n58[matrix-derive.ts]
  n57[CommandPalette.tsx] --> n44[source-doc.ts]
  n57[CommandPalette.tsx] --> n59[triage.ts]
  n60[CommentThread.tsx] --> n6[RequirementsContext.tsx]
  n60[CommentThread.tsx] --> n19[api.ts]
  n60[CommentThread.tsx] --> n37[collaborators.ts]
  n61[ComplianceMatrix.tsx] --> n40[CategoryTag.tsx]
  n61[ComplianceMatrix.tsx] --> n41[ConfidenceIndicator.tsx]
  n61[ComplianceMatrix.tsx] --> n16[AuthContext.tsx]
  n61[ComplianceMatrix.tsx] --> n37[collaborators.ts]
  n61[ComplianceMatrix.tsx] --> n62[dedupe.ts]
  n61[ComplianceMatrix.tsx] --> n58[matrix-derive.ts]
  n61[ComplianceMatrix.tsx] --> n44[source-doc.ts]
  n61[ComplianceMatrix.tsx] --> n59[triage.ts]
  n61[ComplianceMatrix.tsx] --> n8[requirement.ts]
  n63[ControlPanel.tsx] --> n6[RequirementsContext.tsx]
  n63[ControlPanel.tsx] --> n19[api.ts]
  n63[ControlPanel.tsx] --> n37[collaborators.ts]
  n63[ControlPanel.tsx] --> n44[source-doc.ts]
  n63[ControlPanel.tsx] --> n59[triage.ts]
  n5[DemoView.tsx] --> n54[AnimatedNumber.tsx]
  n5[DemoView.tsx] --> n61[ComplianceMatrix.tsx]
  n5[DemoView.tsx] --> n64[GatingHero.tsx]
  n5[DemoView.tsx] --> n65[GraphView.tsx]
  n5[DemoView.tsx] --> n10[SiteHeader.tsx]
  n5[DemoView.tsx] --> n66[SourceVerifyOverlay.tsx]
  n5[DemoView.tsx] --> n67[DemoScrolly.tsx]
  n5[DemoView.tsx] --> n68[DemoTitleCard.tsx]
  n5[DemoView.tsx] --> n69[MountOnView.tsx]
  n5[DemoView.tsx] --> n70[sample.ts]
  n5[DemoView.tsx] --> n71[BookDemoButton.tsx]
  n5[DemoView.tsx] --> n72[BotanicalSprig.tsx]
  n5[DemoView.tsx] --> n73[ClosingArrival.tsx]
  n5[DemoView.tsx] --> n74[DrawOn.tsx]
  n5[DemoView.tsx] --> n75[Reveal.tsx]
  n5[DemoView.tsx] --> n76[SiteFooter.tsx]
  n5[DemoView.tsx] --> n77[FernFrond.tsx]
  n5[DemoView.tsx] --> n78[TreelineDivider.tsx]
  n5[DemoView.tsx] --> n6[RequirementsContext.tsx]
  n5[DemoView.tsx] --> n19[api.ts]
  n5[DemoView.tsx] --> n59[triage.ts]
  n3[DocumentHeader.tsx] --> n10[SiteHeader.tsx]
  n3[DocumentHeader.tsx] --> n6[RequirementsContext.tsx]
  n3[DocumentHeader.tsx] --> n56[categoryStyle.ts]
  n3[DocumentHeader.tsx] --> n59[triage.ts]
  n79[DocxSourceView.tsx] --> n19[api.ts]
  n79[DocxSourceView.tsx] --> n80[dom-highlight.ts]
  n79[DocxSourceView.tsx] --> n81[text-match.ts]
  n55[EvidenceLibrary.tsx] --> n6[RequirementsContext.tsx]
  n46[ExportMenu.tsx] --> n82[export-response.ts]
  n46[ExportMenu.tsx] --> n8[requirement.ts]
  n83[FocusMode.tsx] --> n84[RequirementPanel.tsx]
  n83[FocusMode.tsx] --> n59[triage.ts]
  n83[FocusMode.tsx] --> n8[requirement.ts]
  n51[GapInterview.tsx] --> n47[AnswerStateBadge.tsx]
  n51[GapInterview.tsx] --> n40[CategoryTag.tsx]
  n51[GapInterview.tsx] --> n42[OpenQuestions.tsx]
  n51[GapInterview.tsx] --> n6[RequirementsContext.tsx]
  n51[GapInterview.tsx] --> n44[source-doc.ts]
  n64[GatingHero.tsx] --> n6[RequirementsContext.tsx]
  n64[GatingHero.tsx] --> n62[dedupe.ts]
  n64[GatingHero.tsx] --> n44[source-doc.ts]
  n64[GatingHero.tsx] --> n8[requirement.ts]
  n18[GoogleSignInButton.tsx] --> n19[api.ts]
  n65[GraphView.tsx] --> n40[CategoryTag.tsx]
  n65[GraphView.tsx] --> n41[ConfidenceIndicator.tsx]
  n65[GraphView.tsx] --> n6[RequirementsContext.tsx]
  n65[GraphView.tsx] --> n19[api.ts]
  n65[GraphView.tsx] --> n56[categoryStyle.ts]
  n65[GraphView.tsx] --> n44[source-doc.ts]
  n65[GraphView.tsx] --> n85[structure.ts]
  n65[GraphView.tsx] --> n8[requirement.ts]
  n86[MarksView.tsx] --> n6[RequirementsContext.tsx]
  n86[MarksView.tsx] --> n44[source-doc.ts]
  n86[MarksView.tsx] --> n85[structure.ts]
  n86[MarksView.tsx] --> n8[requirement.ts]
  n21[MatrixView.tsx] --> n36[ActivityFeed.tsx]
  n21[MatrixView.tsx] --> n54[AnimatedNumber.tsx]
  n21[MatrixView.tsx] --> n2[AppMain.tsx]
  n21[MatrixView.tsx] --> n87[ApprovalStamp.tsx]
  n21[MatrixView.tsx] --> n88[BulkActionBar.tsx]
  n21[MatrixView.tsx] --> n57[CommandPalette.tsx]
  n21[MatrixView.tsx] --> n61[ComplianceMatrix.tsx]
  n21[MatrixView.tsx] --> n63[ControlPanel.tsx]
  n21[MatrixView.tsx] --> n3[DocumentHeader.tsx]
  n21[MatrixView.tsx] --> n79[DocxSourceView.tsx]
  n21[MatrixView.tsx] --> n83[FocusMode.tsx]
  n21[MatrixView.tsx] --> n64[GatingHero.tsx]
  n21[MatrixView.tsx] --> n52[NoTenderLoaded.tsx]
  n21[MatrixView.tsx] --> n89[PdfSourceView.tsx]
  n21[MatrixView.tsx] --> n90[RequirementDrawer.tsx]
  n21[MatrixView.tsx] --> n84[RequirementPanel.tsx]
  n21[MatrixView.tsx] --> n91[RequirementSpine.tsx]
  n21[MatrixView.tsx] --> n92[ShareControl.tsx]
  n21[MatrixView.tsx] --> n93[SheetSourceView.tsx]
  n21[MatrixView.tsx] --> n6[RequirementsContext.tsx]
  n21[MatrixView.tsx] --> n19[api.ts]
  n21[MatrixView.tsx] --> n94[export-matrix-xlsx.ts]
  n21[MatrixView.tsx] --> n58[matrix-derive.ts]
  n21[MatrixView.tsx] --> n44[source-doc.ts]
  n21[MatrixView.tsx] --> n81[text-match.ts]
  n21[MatrixView.tsx] --> n59[triage.ts]
  n21[MatrixView.tsx] --> n8[requirement.ts]
  n52[NoTenderLoaded.tsx] --> n6[RequirementsContext.tsx]
  n52[NoTenderLoaded.tsx] --> n19[api.ts]
  n42[OpenQuestions.tsx] --> n6[RequirementsContext.tsx]
  n42[OpenQuestions.tsx] --> n8[requirement.ts]
  n89[PdfSourceView.tsx] --> n19[api.ts]
  n89[PdfSourceView.tsx] --> n81[text-match.ts]
  n95[ProcessingView.tsx] --> n54[AnimatedNumber.tsx]
  n95[ProcessingView.tsx] --> n19[api.ts]
  n53[ReadinessLedger.tsx] --> n46[ExportMenu.tsx]
  n53[ReadinessLedger.tsx] --> n43[answers.ts]
  n53[ReadinessLedger.tsx] --> n8[requirement.ts]
  n90[RequirementDrawer.tsx] --> n84[RequirementPanel.tsx]
  n90[RequirementDrawer.tsx] --> n8[requirement.ts]
  n84[RequirementPanel.tsx] --> n39[AnswerPanel.tsx]
  n84[RequirementPanel.tsx] --> n87[ApprovalStamp.tsx]
  n84[RequirementPanel.tsx] --> n40[CategoryTag.tsx]
  n84[RequirementPanel.tsx] --> n60[CommentThread.tsx]
  n84[RequirementPanel.tsx] --> n41[ConfidenceIndicator.tsx]
  n84[RequirementPanel.tsx] --> n66[SourceVerifyOverlay.tsx]
  n84[RequirementPanel.tsx] --> n16[AuthContext.tsx]
  n84[RequirementPanel.tsx] --> n6[RequirementsContext.tsx]
  n84[RequirementPanel.tsx] --> n19[api.ts]
  n84[RequirementPanel.tsx] --> n37[collaborators.ts]
  n84[RequirementPanel.tsx] --> n44[source-doc.ts]
  n84[RequirementPanel.tsx] --> n8[requirement.ts]
  n91[RequirementSpine.tsx] --> n41[ConfidenceIndicator.tsx]
  n91[RequirementSpine.tsx] --> n59[triage.ts]
  n92[ShareControl.tsx] --> n6[RequirementsContext.tsx]
  n92[ShareControl.tsx] --> n19[api.ts]
  n92[ShareControl.tsx] --> n37[collaborators.ts]
  n93[SheetSourceView.tsx] --> n19[api.ts]
  n93[SheetSourceView.tsx] --> n81[text-match.ts]
  n10[SiteHeader.tsx] --> n35[AccountMenu.tsx]
  n10[SiteHeader.tsx] --> n96[BrandLogo.tsx]
  n10[SiteHeader.tsx] --> n97[SectionNav.tsx]
  n10[SiteHeader.tsx] --> n71[BookDemoButton.tsx]
  n66[SourceVerifyOverlay.tsx] --> n79[DocxSourceView.tsx]
  n66[SourceVerifyOverlay.tsx] --> n89[PdfSourceView.tsx]
  n66[SourceVerifyOverlay.tsx] --> n93[SheetSourceView.tsx]
  n66[SourceVerifyOverlay.tsx] --> n19[api.ts]
  n66[SourceVerifyOverlay.tsx] --> n44[source-doc.ts]
  n66[SourceVerifyOverlay.tsx] --> n81[text-match.ts]
  n66[SourceVerifyOverlay.tsx] --> n8[requirement.ts]
  n14[StructureView.tsx] --> n65[GraphView.tsx]
  n14[StructureView.tsx] --> n86[MarksView.tsx]
  n14[StructureView.tsx] --> n52[NoTenderLoaded.tsx]
  n14[StructureView.tsx] --> n90[RequirementDrawer.tsx]
  n14[StructureView.tsx] --> n6[RequirementsContext.tsx]
  n14[StructureView.tsx] --> n19[api.ts]
  n14[StructureView.tsx] --> n85[structure.ts]
  n14[StructureView.tsx] --> n59[triage.ts]
  n14[StructureView.tsx] --> n8[requirement.ts]
  n31[TeamsManager.tsx] --> n19[api.ts]
  n31[TeamsManager.tsx] --> n37[collaborators.ts]
  n98[TendersList.tsx] --> n6[RequirementsContext.tsx]
  n98[TendersList.tsx] --> n19[api.ts]
  ...
  n62[dedupe.ts] --> n8[requirement.ts]
  n80[dom-highlight.ts] --> n81[text-match.ts]
  n94[export-matrix-xlsx.ts] --> n41[ConfidenceIndicator.tsx]
  n94[export-matrix-xlsx.ts] --> n82[export-response.ts]
  n94[export-matrix-xlsx.ts] --> n44[source-doc.ts]
  n94[export-matrix-xlsx.ts] --> n8[requirement.ts]
  n82[export-response.ts] --> n44[source-doc.ts]
  n82[export-response.ts] --> n8[requirement.ts]
  n58[matrix-derive.ts] --> n62[dedupe.ts]
  n58[matrix-derive.ts] --> n85[structure.ts]
  n58[matrix-derive.ts] --> n59[triage.ts]
  n58[matrix-derive.ts] --> n8[requirement.ts]
...
*988 tracked files mapped. Generated by `scripts/gen_codemap.py`.*
